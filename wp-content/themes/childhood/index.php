                ...
                <ul class="glide__slides">
                    <?php
                        ...
                        $my_posts = get_posts( array(
                            ...
                            'category_name'    => 'slider', //ярлык рубрики
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('address_BC', 2) ?>
                            <br> <br>
                            <?php the_field('address_addr', 2) ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="t<?php the_field('phone_1', 2) ?>"><?php the_field('phone_1', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
